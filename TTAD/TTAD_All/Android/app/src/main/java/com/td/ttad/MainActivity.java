...
public class MainActivity extends AppCompatActivity {
    ...
    // 激励视频
    public Button mBtnLoadHorizontalAD;
    public Button mBtnLoadVerticalAD;
    public Button mBtnShowVideo;

    // Banner 广告
    private FrameLayout mFLBannerContainer;
    private Button mBtnBannerAD;

    // 闪屏广告
    private Button mBtnInterstitialAd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnLoadHorizontalAD = (Button) findViewById(R.id.btnLoadHorizontalAD);
        mBtnLoadHorizontalAD.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mBtnLoadVerticalAD = (Button) findViewById(R.id.btnLoadVerticalAD);
        mBtnLoadVerticalAD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LoadVerticalAD();
            }
        ...
        mBtnShowVideo = (Button) findViewById(R.id.btnShowVideo);
        mBtnShowVideo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShowVedio();
            }
        ...
        mBtnBannerAD = (Button) findViewById(R.id.btnBannerAD);
        mBtnBannerAD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                bannerLandingpage();
            }
        ...
        mBtnInterstitialAd = (Button) findViewById(R.id.btnLoadInteraction);
        mBtnInterstitialAd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LoadInteractionAd();
            }
